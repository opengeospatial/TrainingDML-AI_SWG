:Title: OGC Training Data Markup Language for Artificial Intelligence (TrainingDML-AI) Part1: Conceptual Model Standard
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Internal reference number of this OGC(R) document: 23-008r2
|Version: 1.0.0
...
include::clause_7_uml_model.adoc[]

include::clause_8_data_dictionary.adoc[]
