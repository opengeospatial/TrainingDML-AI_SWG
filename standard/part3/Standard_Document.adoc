:Title: OGC Training Data Markup Language for Artificial Intelligence (TrainingDML-AI) Part 3: XML Encoding Standard
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Internal reference number of this OGC(R) document: 24-007r1
|Version: 1.0
|Editor: Peng Yue, Ruixiang Liu, Kaixuan Wang
|===
