...
|Requirement 13|/req/aitrainingdata/trainingdata
|Requirement 14|/req/aitrainingdataset/trainingtypecode
|Requirement 15|/req/aitrainingdata/eotrainingdata
|===
...
|===
|Requirement 13|/req/aitrainingdataset/trainingdata
...
[width="100%",cols="20%,80%",]
|===
|Requirement 15|/req/aitrainingdataset/eotrainingdata
