:Title: OGC Training Data Markup Language for Artificial Intelligence (TrainingDML-AI) Part 2: JSON Encoding Standard
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Internal reference number of this OGC(R) document: 24-006r1
|Version: 1.0.0
|Editor: Peng Yue, Ruixiang Liu, Boyi Shangguan
|===
