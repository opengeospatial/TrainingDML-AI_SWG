...
|Requirement |/req/base/jsonbasetype/datatime, /req/base/jsonbasetype/namedvalue, /req/base/jsonbasetype/url, /req/base/isometadatatype, /req/base/isoqualitytype, /req/base/geospatialtype
