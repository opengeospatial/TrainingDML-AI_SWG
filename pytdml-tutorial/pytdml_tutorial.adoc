:Title: OGC Training Data Markup Language for Artificial Intelligence (TrainingDML-AI) Python Package Extension: PyTDML
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Editor: Peng Yue, Ruixiang Liu, Yongyi Mi, Yang Zhang, Ming Zhao, Shuaiqi Liu
|===
...
include::clause_2_io_module.adoc[]

include::clause_3_machine_learning_module.adoc[]

include::clause_4_use_case.adoc[]